...
function Sectionpart1() {
  return (
    <div className='p-10 max-sm:p-0 w-[30%] max-lg:w-full'>
          <p className='headingfont max-lg:text-center'>CHARGED WITH <span className='text-red-900'>DUI?</span></p>
          <p className='text-red-900 pr-3 text-[20px] font-semibold flex justify-start max-lg:justify-center'>FREE CASE EVALUATION</p>
          <div className='flex max-xl:flex-col-reverse py-5'>
            <div className='flex flex-col max-lg:text-center gap-3 xl:w-[80%]'>
          ...
          <div className='2xl:w-[70%] max-2xl:w-[80%] max-xl:w-full border-t-2 border-gray-400'/>
            <button className='mr-[6%] max-md:mx-auto max-md:mb-10'>
