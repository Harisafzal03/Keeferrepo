    ...
    <div className="App">
      ...
      <div className='flex max-lg:flex-col p-12'>
        ...
        <div className='w-[53%] lg:px-14 max-lg:w-full'>
          <h1 className='mainheading text-3xl'>PAGE TITLE HERE</h1>
        ...
        <img src={Bulletwhite} alt="BulletWhite" width={12} />
          ...
          <img src={TopAttorney} alt="TopAttorney" className='aspect-[3/3] lg:w-full'/>
          </div>
          <div className='px-16 my-10'>
          ...
          <p className='headingfont'>FOLLOW <span className='text-red-900'>US</span></p>
              ...
              <div className='flex justify-between pt-5'>
                <div>
              <img src={Facebook} alt="Facebook" className='w-[60px]'/>
              </div>
              <div>
              <img src={Google} alt="Google" className='w-[60px]'/>
              </div>
              <div>
